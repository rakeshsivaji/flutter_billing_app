...
class _ProfileState extends State<Profile> {
  ...
  void openFiles() async {
    ...
    if (resultFile != null) {
      ...
      Fluttertoast.showToast(
        msg: 'சுயவிவரப் படத்தைப் புதுப்பிக்க முடியவில்லை',
        toastLength: Toast.LENGTH_SHORT,
        gravity: ToastGravity.BOTTOM,
        timeInSecForIosWeb: 1,
        backgroundColor: Colors.lightBlue,
  ...
  void changePassword() async {
    if (_formKey.currentState!.validate()) {
      if (newpassword.text != confirmpassword.text) {
        Fluttertoast.showToast(
          msg:
              'புதிய கடவுச்சொல் மற்றும் உறுதிப்படுத்தல் கடவுச்சொல் பொருந்தவில்லை.',
          toastLength: Toast.LENGTH_SHORT,
          gravity: ToastGravity.BOTTOM,
          timeInSecForIosWeb: 1,
          backgroundColor: const Color.fromARGB(255, 88, 58, 197),
      ...
      if (oldpassword.text == newpassword.text) {
        Fluttertoast.showToast(
          msg:
              'தொடர பழைய கடவுச்சொல் மற்றும் புதிய கடவுச்சொல் வேறு வேறு என்பதை உறுதி செய்யவும்.',
          toastLength: Toast.LENGTH_SHORT,
          gravity: ToastGravity.BOTTOM,
          timeInSecForIosWeb: 1,
          backgroundColor: const Color.fromARGB(255, 88, 58, 197),
      ...
      try {
        ...
        if (response['status'] == 1) {
          ...
          Fluttertoast.showToast(
            msg: 'கடவுச்சொல் மாற்றப்படவில்லை',
            toastLength: Toast.LENGTH_SHORT,
            gravity: ToastGravity.BOTTOM,
            timeInSecForIosWeb: 1,
            backgroundColor: const Color.fromARGB(255, 88, 58, 197),
