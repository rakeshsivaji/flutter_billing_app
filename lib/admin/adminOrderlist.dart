...
class Admin_page_Orderlist extends StatefulWidget {
  const Admin_page_Orderlist({super.key});

  @override
  State<Admin_page_Orderlist> createState() => _Admin_page_OrderlistState();
}

class _Admin_page_OrderlistState extends State<Admin_page_Orderlist>
  ...
  String? totalAmount;
  bool isClicked = true;
  AdminOrderControllerImpl controller = AdminOrderControllerImpl();

  @override
  void initState() {
    super.initState();
    storeId = Get.arguments['id'].toString();
    dayDropdownValue = Get.arguments['dayDropdownValue'].toString();
