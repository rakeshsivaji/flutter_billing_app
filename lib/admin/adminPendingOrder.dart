...
class Admin_Page_PendingOrder extends StatefulWidget {
  const Admin_Page_PendingOrder({super.key});

  @override
  State<Admin_Page_PendingOrder> createState() =>
      _Admin_Page_PendingOrderState();
}

class _Admin_Page_PendingOrderState extends State<Admin_Page_PendingOrder> {
  bool? isChecked = true;
  List<bool> ischecked = [];
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        ...
        // Get.back();
        // Get.toNamed('/adminorderlist', arguments: {'id': storeId});
        return false;
      },
      child: Scaffold(
